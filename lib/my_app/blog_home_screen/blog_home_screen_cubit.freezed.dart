...
/// @nodoc
abstract class $BlogHomeScreenStateCopyWith<T, $Res> {
  factory $BlogHomeScreenStateCopyWith(BlogHomeScreenState<T> value,
          $Res Function(BlogHomeScreenState<T>) then) =
      _$BlogHomeScreenStateCopyWithImpl<T, $Res, BlogHomeScreenState<T>>;
}

/// @nodoc
class _$BlogHomeScreenStateCopyWithImpl<T, $Res,
        $Val extends BlogHomeScreenState<T>>
    implements $BlogHomeScreenStateCopyWith<T, $Res> {
  _$BlogHomeScreenStateCopyWithImpl(this._value, this._then);
...
class __$$_InitialCopyWithImpl<T, $Res>
    extends _$BlogHomeScreenStateCopyWithImpl<T, $Res, _$_Initial<T>>
...
class _$_Initial<T> implements _Initial<T> {
  ...
  @override
  String toString() {
    return 'BlogHomeScreenState<$T>.initial()';
  }
...
class __$$_DataCopyWithImpl<T, $Res>
    extends _$BlogHomeScreenStateCopyWithImpl<T, $Res, _$_Data<T>>
...
class _$_Data<T> implements _Data<T> {
  ...
  @override
  String toString() {
    return 'BlogHomeScreenState<$T>.data(data: $data)';
  }
...
abstract class _Data<T> implements BlogHomeScreenState<T> {
